...
export const successStories = mysqlTable("success_stories", {
  ...
  clientType: mysqlEnum("client_type", ["FamilyOffice", "PrivateInvestor", "Institutional", "Developer", "Partner"]),
  location: varchar("location", { length: 255 }),
  propertyType: varchar("property_type", { length: 100 }),
  investmentAmount: varchar("investment_amount_str", { length: 100 }),
  returnAchieved: varchar("return_achieved", { length: 100 }),
  ...
  images: json("images").$type<string[]>(),
  featured: boolean("featured").default(false),
  featuredMonth: varchar("featured_month", { length: 7 }),
...
export const leads = mysqlTable("leads", {
  ...
  interestedRegions: text("interested_regions"),
  interestedPropertyTypes: text("interested_property_types"),
