  ...
  return (
    <Layout>
      ...
      {comparisonProperties.length > 0 && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-white shadow-2xl rounded-lg border-2 border-primary p-4 min-w-[400px]">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <Scale className="w-5 h-5 text-primary" />
              <span className="font-semibold">Compare Properties ({comparisonProperties.length}/3)</span>
            </div>
          ...
          <div className="flex gap-2 mb-3">
            {comparisonProperties.map((property) => (
              <div key={property.id} className="flex-1 bg-muted rounded p-2 text-sm">
