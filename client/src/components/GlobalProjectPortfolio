      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <Link href="/investments/southeast-asia" className="block">
            <Card className="relative overflow-hidden border-4 border-secondary hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
          ...
          <Link href="/investments/europe" className="block">
            <Card className="overflow-hidden border-2 border-border hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
