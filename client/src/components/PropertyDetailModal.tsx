                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-sm">
                        ...
                        <div><span className="text-muted-foreground">Land Price per sqm:</span> <span className="font-medium">{property.landPricePerSqm && Number(property.landPricePerSqm) > 0 ? `${property.currency || 'PHP'} ${Number(property.landPricePerSqm).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : 'N/A'}</span></div>
