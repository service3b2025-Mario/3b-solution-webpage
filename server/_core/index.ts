...
async function startServer() {
  ...
  app.use((_req, res, next) => {
    ...
    res.setHeader('Content-Security-Policy', [
      ...
      "connect-src 'self' https://cdn.3bsolution.com https://d2xsxph8kpxj0f.cloudfront.net https://sentry-new.tidio.co https://socket.tidio.co wss://socket.tidio.co https://uploads.tidio.com https://www.google-analytics.com https://api.frankfurter.dev https://maps.googleapis.com https://*.3bsolution.com https://*.r2.dev",
